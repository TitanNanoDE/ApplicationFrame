...
var _ArrayUtil = require('../../core/objects/ArrayUtil.js');
...
const IndexedQueryCompiler = {
    ...
    where: function (indexName) {
        this._currentQuery = (0, _make.Make)(IndexedQuery)();
                ...
                return new Promise((done, error) => {
                    ...
                    request.onsuccess = ({ target: { result: cursor } }) => {
                        ...
                        if (matches.indexOf(JSON.stringify(cursor.primaryKey)) < 0) {
                            let doesMatch = true;
                            let keyCount = query.rangeStart && query.rangeStart.length || query.rangeEnd && query.rangeEnd.length;
