 ...
 */
let ObjectParser = exports.ObjectParser = function (source) {
    let target = null;
    let key = false;
    let keyBuffer = '';
    let valueBuffer = '';
 ...
 */
let parseExpression = exports.parseExpression = function (expression, ...contexts) {
 ...
 * @return {void}
 */
let assignExpression = exports.assignExpression = function (expression, scope, value) {
